 ...
 * @param {number} code
 */
export function setStatusCode<Response extends ServerResponse & ExpectedResponse>(res: Response, code: number): void;
/**
 ...
 */
export function send<Request extends IncomingMessage, Response extends ServerResponse>(res: Response & ExpectedResponse, bufferOrStream: string | Buffer): void;
/**
 * @template {ServerResponse} Response
 * @param {Response & ExpectedResponse} res
 * @param {import("fs").ReadStream} bufferOrStream
 */
export function pipe<Response extends ServerResponse>(res: Response & ExpectedResponse, bufferOrStream: import("fs").ReadStream): void;
/**
 ...
 */
export function createReadStreamOrReadFileSync(filename: string, outputFileSystem: import("../index").OutputFileSystem, start: number, end: number): {
